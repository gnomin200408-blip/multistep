...
export const Next = ({ btnText, slideNumber, onClick, width, disabled }) => {
  ...
  return (
    <button
      className={`h-[44px] rounded-lg flex justify-center items-center cursor-pointer  gap-1 transition-all duration-100 bg-black ${disabled() ? "opacity-60 " : "opacity-100"} `}
      style={{ width }}
    >
